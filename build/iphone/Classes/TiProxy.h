...
//Rare exceptions to indicate a bug in the _comherringtonnp code (Eg, function that a subclass should have implemented)
...
/**
 The base class for comherringtonnp proxies.
 */
