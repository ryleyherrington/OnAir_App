...
/**
 The base class for all comherringtonnp modules
 */
...
/**
 comherringtonnp Platform calls this method on startup.
 */
-(void)startup;

/**
 comherringtonnp Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 comherringtonnp Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 comherringtonnp Platform calls this method on resume.
 @param sender The sender of the event.
 */
