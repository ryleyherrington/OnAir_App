 ...
 * Copyright (c) 2009-2011 by comherringtonnp, Inc. All Rights Reserved.
...
//@interface comherringtonnpObject : NSObject
//@end

@interface comherringtonnpObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[comherringtonnpObject class]])
		{
			for (NSString *key in [[(comherringtonnpObject*)o modules] allKeys])
			{
