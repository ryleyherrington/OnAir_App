...
@interface comherringtonnpObject : KrollCoverageObject {
#else
@interface comherringtonnpObject : KrollObject {
#endif
@private
...
extern NSString * comherringtonnp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	comherringtonnpObject *_comherringtonnp;
	BOOL shutdown;
