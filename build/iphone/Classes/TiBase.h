...
// in simulator we redefine to format for comherringtonnp Developer console
...
{\
	NSString * exceptionName = [@"org.comherringtonnp." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.comherringtonnp";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIcomherringtonnpNativeItemNone = -1, 
	UIcomherringtonnpNativeItemSpinner = -2,
	UIcomherringtonnpNativeItemProgressBar = -3,
	
	UIcomherringtonnpNativeItemSlider = -4,
	UIcomherringtonnpNativeItemSwitch = -5,
	UIcomherringtonnpNativeItemMultiButton = -6,
	UIcomherringtonnpNativeItemSegmented = -7,
	
	UIcomherringtonnpNativeItemTextView = -8,
	UIcomherringtonnpNativeItemTextField = -9,
	UIcomherringtonnpNativeItemSearchBar = -10,
	
	UIcomherringtonnpNativeItemPicker = -11,
	UIcomherringtonnpNativeItemDatePicker = -12,
	
	UIcomherringtonnpNativeItemInfoLight = -13,
	UIcomherringtonnpNativeItemInfoDark = -14,
	
	UIcomherringtonnpNativeItemDisclosure = -15,
	
	UIcomherringtonnpNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all comherringtonnp instances of
